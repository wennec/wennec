...
CREATE TABLE `tbl_colegios`  (
  ...
  `ubicacion` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `representanteLegal` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
...
INSERT INTO `tbl_colegios` VALUES (2, 'Gimnasio Sabana Norte', NULL, NULL, NULL, 600347, NULL, NULL, NULL, NULL);
...
CREATE TABLE `tbl_eleccion`  (
  `PK_id` int(11) NOT NULL AUTO_INCREMENT,
  `nombreEleccion` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  ...
  `updated_at` timestamp(0) NULL DEFAULT NULL,
  PRIMARY KEY (`PK_id`) USING BTREE,
  INDEX `tbl_eleccion_ibfk_1`(`FK_ColegioId`) USING BTREE,
...
CREATE TABLE `tbl_eleccionestudiante`  (
  `PK_id` int(11) NOT NULL AUTO_INCREMENT,
  `FK_EleccionId` int(11) NULL DEFAULT NULL,
  `FK_UsuarioId` int(11) NULL DEFAULT NULL,
  `created_at` timestamp(0) NULL DEFAULT NULL,
  `updated_at` timestamp(0) NULL DEFAULT NULL,
  PRIMARY KEY (`PK_id`) USING BTREE,
  INDEX `FK_UsuarioId`(`FK_UsuarioId`) USING BTREE,
  INDEX `FK_EleccionId`(`FK_EleccionId`) USING BTREE,
...
-- ----------------------------
DROP TABLE IF EXISTS `tbl_estadoprematricula`;
CREATE TABLE `tbl_estadoprematricula`  (
  `PK_id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of tbl_estadoprematricula
-- ----------------------------
INSERT INTO `tbl_estadoprematricula` VALUES (1, 'Inactivo');
INSERT INTO `tbl_estadoprematricula` VALUES (2, 'Activo');
INSERT INTO `tbl_estadoprematricula` VALUES (3, 'Finalizado Correctamente');
INSERT INTO `tbl_estadoprematricula` VALUES (4, 'Finalizado Incorrectamente');
...
CREATE TABLE `tbl_estadovotoestudiante`  (
  `PK_id` int(11) NOT NULL AUTO_INCREMENT,
  `votoEstudiante` tinyint(4) NULL DEFAULT 0,
  `FK_VotoEstudianteId` int(11) NULL DEFAULT NULL,
  `created_at` timestamp(0) NULL DEFAULT NULL,
  `updated_at` timestamp(0) NULL DEFAULT NULL,
  PRIMARY KEY (`PK_id`) USING BTREE,
...
CREATE TABLE `tbl_evaluaciondocente`  (
  `PK_id` int(11) NOT NULL AUTO_INCREMENT,
  `puntualidad` int(11) NULL DEFAULT 0,
  `dinamismo` int(11) NULL DEFAULT NULL,
  `respeto` int(11) NULL DEFAULT NULL,
  `actitud` int(11) NULL DEFAULT NULL,
  `FK_UsuarioId` int(11) NULL DEFAULT NULL,
  `FK_EstudianteId` int(11) NULL DEFAULT NULL,
  `FK_FechaId` int(11) NULL DEFAULT NULL,
  `created_at` timestamp(0) NULL DEFAULT NULL,
  `updated_at` timestamp(0) NULL DEFAULT NULL,
  PRIMARY KEY (`PK_id`) USING BTREE,
  INDEX `FK_UsuarioId`(`FK_UsuarioId`) USING BTREE,
  INDEX `FK_EstudianteId`(`FK_EstudianteId`) USING BTREE,
  INDEX `FK_FechaId`(`FK_FechaId`) USING BTREE,
...
CREATE TABLE `tbl_logro`  (
  `PK_id` int(11) NOT NULL AUTO_INCREMENT,
  `nombreLogro` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `descripcion` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `FK_Periodo` int(11) NULL DEFAULT NULL,
  `FK_GrupoMateria` int(11) NULL DEFAULT NULL,
  `created_at` timestamp(0) NULL DEFAULT NULL,
  `updated_at` timestamp(0) NULL DEFAULT NULL,
  PRIMARY KEY (`PK_id`) USING BTREE,
  INDEX `FK_GrupoMateria`(`FK_GrupoMateria`) USING BTREE,
...
CREATE TABLE `tbl_noticias`  (
  `PK_id` int(11) NOT NULL AUTO_INCREMENT,
  `tipoNoticia` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `imagenNoticia` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `descripcion` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `fechaInicio` date NULL DEFAULT NULL,
  `fechaFin` date NULL DEFAULT NULL,
  `FK_ColegioId` int(11) NULL DEFAULT NULL,
...
-- ----------------------------
-- Table structure for tbl_prematricula
-- ----------------------------
DROP TABLE IF EXISTS `tbl_prematricula`;
CREATE TABLE `tbl_prematricula`  (
  `PK_id` int(11) NOT NULL AUTO_INCREMENT,
  `nombreEstudiante` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `numeroDocumentoEstudiante` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `FK_Grupo` int(11) NULL DEFAULT NULL,
  `correoEstudiante` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `direccionResidencia` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `nombrePadre` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `nombreMadre` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `nombreAcudiente` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `telefonoAcudiente` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `correoAcudiente` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `FK_Estado` int(11) NULL DEFAULT NULL,
  `codigoColegio` int(11) NULL DEFAULT NULL,
  `created_at` timestamp(0) NULL DEFAULT NULL,
  `updated_at` timestamp(0) NULL DEFAULT NULL,
  PRIMARY KEY (`PK_id`) USING BTREE,
  INDEX `FK_Grupo`(`FK_Grupo`) USING BTREE,
  INDEX `codigoColegio`(`codigoColegio`) USING BTREE,
  INDEX `FK_Estado`(`FK_Estado`) USING BTREE,
  CONSTRAINT `tbl_prematricula_ibfk_1` FOREIGN KEY (`FK_Grupo`) REFERENCES `tbl_grupos` (`PK_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `tbl_prematricula_ibfk_2` FOREIGN KEY (`codigoColegio`) REFERENCES `tbl_colegios` (`codigo`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `tbl_prematricula_ibfk_3` FOREIGN KEY (`FK_Estado`) REFERENCES `tbl_estadoprematricula` (`PK_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of tbl_prematricula
-- ----------------------------
INSERT INTO `tbl_prematricula` VALUES (1, 'Samuel Osma Serrato', '1023456897', 2, NULL, 'Barrio Los Olivos - Facatativa', 'John Osma', 'Paola Serrato', 'Paola Serrato', '3124865987', 'paolaser@gmail.com', 1, 600347, '2019-09-28 16:38:24', '2019-09-28 16:38:24');
INSERT INTO `tbl_prematricula` VALUES (4, 'Pepito Perez', '1023523698', 1, 'pepe@gmail.com', 'Barrio Los Olivos - Facatativa', 'John Osma', 'Paola Serrato', 'Paola Serrato', '3124865987', 'paolaser@gmail.com', 2, 600347, '2019-09-28 16:46:14', '2019-09-28 16:46:14');
...
CREATE TABLE `tbl_reportes`  (
  `PK_id` int(11) NOT NULL AUTO_INCREMENT,
  `tipo_reporte` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `created_at` timestamp(0) NULL DEFAULT NULL,
  `updated_at` timestamp(0) NULL DEFAULT NULL,
  PRIMARY KEY (`PK_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `tbl_usuarioreporte`  (
  `PK_id` int(11) NOT NULL AUTO_INCREMENT,
  `FK_UsuarioId` int(11) NULL DEFAULT NULL,
  `FK_ReporteId` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`PK_id`) USING BTREE,
  INDEX `FK_UsuarioId`(`FK_UsuarioId`) USING BTREE,
  INDEX `FK_ReporteId`(`FK_ReporteId`) USING BTREE,
...
-- ----------------------------
INSERT INTO `tbl_usuarios` VALUES (1, 'Code Freestyle', NULL, NULL, NULL, 'root@app.com', '$2y$10$/opF8B6oJ66fKE9UobDxR.hwUIXdsgyGMVeC9QU/4bjYxaKHP6oqi', 'FotoP.1569795095.png', 1, NULL, 'nQTdU3FLNZV1tOSthiD79m4oQD8fLJ6X92fAZdbCNfZDano8hc8SCJEoTxXl', NULL, '2019-09-29 17:11:35');
INSERT INTO `tbl_usuarios` VALUES (2, 'admingimnasio', NULL, NULL, NULL, 'admingimnasio@mail.com', '$2y$10$LZ0fVWNaDyJoAVjATFe0Nun5CHWa2/4IvjRDwUQ0oQJIBKOK9KJ5q', 'FotoP.1569198005.JPG', 2, 2, 'jgAicBO7C62TKT6sU76C2haav2GvjtWIE2vBK3imo1vGPEszK5r0IzjXCvYf', NULL, '2019-09-22 19:20:05');
...
INSERT INTO `tbl_usuarios` VALUES (5, 'Stevenson', NULL, NULL, NULL, 'stevenson@gmail.com', '$2y$10$uoGk6wXzsBeefLamLqsZROy9dHXC1N/hPDFAhT.LwamnneSQLVyLO', NULL, 4, 2, '0tHjWkr7o42ZngvFxd9A8A4u4iIir5BqqpbLDlOzex9qwQkXccscJBlRqRRC', NULL, NULL);
...
INSERT INTO `tbl_usuarios` VALUES (9, 'Sandra Serrato', NULL, NULL, NULL, 'sandra@mail.com', '$2y$10$0yCUIdxpfh0GrVIXWWU8SuaOfFL1AyfKIP2dYD1CkTVJn03ywPRwO', NULL, 4, 2, 'OW7bCbQtY2VjGTpeTtQawi1RakJYJ5GW0AgfF7K8Slklmd5f1ZaezKBy7TYr', '2019-08-26 16:08:06', '2019-08-26 16:08:06');
...
INSERT INTO `tbl_usuarios` VALUES (11, 'luisa', NULL, NULL, NULL, 'luisa@mail.com', '$2y$10$QrEYimN/xaAGLk7WONpGheTbJhVdlfvRqVuIcV8dygOIhSmCH7uSi', NULL, 5, NULL, 'ISKYBJp9nhNJ9yo8bnBhAjRtuWFGLXdkJXRPVLvFfaQSXBpJAnvezVITZk3w', '2019-08-26 16:17:17', '2019-08-26 16:17:17');
...
CREATE TABLE `tbl_votoestudiante`  (
  ...
  `FK_EleccionEstudiante` int(11) NULL DEFAULT NULL,
  `created_at` timestamp(0) NULL DEFAULT NULL,
  `updated_at` timestamp(0) NULL DEFAULT NULL,
  PRIMARY KEY (`PK_id`) USING BTREE,
  INDEX `FK_UsuarioId`(`FK_UsuarioId`) USING BTREE,
