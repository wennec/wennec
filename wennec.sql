...
CREATE TABLE `tbl_calidadinstitucion`  (
  ...
  `archivo` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
...
CREATE TABLE `tbl_colegios`  (
  ...
  `ubicacion` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `representanteLegal` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `nit` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
...
INSERT INTO `tbl_colegios` VALUES (9, 'hola', 'prueba', 'prueba', '2345345456', 733760, '', 3, '2019-10-03 09:37:36', '2019-10-03 09:40:02');
...
CREATE TABLE `tbl_diahorario`  (
  `PK_id` int(11) NOT NULL AUTO_INCREMENT,
  `dia` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  PRIMARY KEY (`PK_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Compact;
...
CREATE TABLE `tbl_eleccion`  (
  `PK_id` int(11) NOT NULL AUTO_INCREMENT,
  `nombreEleccion` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
...
CREATE TABLE `tbl_eventos`  (
  `PK_id` int(11) NOT NULL AUTO_INCREMENT,
  `tipo_evento` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  PRIMARY KEY (`PK_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Compact;
...
CREATE TABLE `tbl_eventosgenerales`  (
  `PK_id` int(11) NOT NULL AUTO_INCREMENT,
  `titulo_evento` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `fecha` date NULL DEFAULT NULL,
...
INSERT INTO `tbl_horario` VALUES (5, '11:00:00', '13:00:00', 2, '2019-10-03 17:22:14', '2019-10-03 17:22:14');
...
INSERT INTO `tbl_horariomateria` VALUES (4, 5, 1, '2019-10-03 17:22:14', '2019-10-03 17:22:14');
...
CREATE TABLE `tbl_logro`  (
  `PK_id` int(11) NOT NULL AUTO_INCREMENT,
  `nombreLogro` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `descripcion` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
...
CREATE TABLE `tbl_noticias`  (
  `PK_id` int(11) NOT NULL AUTO_INCREMENT,
  `tipoNoticia` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `imagenNoticia` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `descripcion` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `fechaInicio` date NULL DEFAULT NULL,
  `fechaFin` date NULL DEFAULT NULL,
  `FK_ColegioId` int(11) NULL DEFAULT NULL,
...
-- ----------------------------
-- Records of tbl_observaciondocente
-- ----------------------------
INSERT INTO `tbl_observaciondocente` VALUES (1, 'Favor corregir olimpiada en el cuaderno respectivo para recuperacion y sustentacion oral');
INSERT INTO `tbl_observaciondocente` VALUES (2, 'Favor repasar en casa los temas abordados durante el periodo');
INSERT INTO `tbl_observaciondocente` VALUES (3, 'Felicitaciones por tu desempeño');
INSERT INTO `tbl_observaciondocente` VALUES (4, 'Felicitaciones por tu excelente desempeño. ¡ Continua asi !');
...
CREATE TABLE `tbl_observacionestudiante`  (
  `PK_id` int(11) NOT NULL AUTO_INCREMENT,
  `FK_Estudiante` int(11) NULL DEFAULT NULL,
  `FK_ObservacionDocente` int(11) NULL DEFAULT NULL,
  `FK_Materia` int(11) NULL DEFAULT NULL,
  `FK_Periodo` int(11) NULL DEFAULT NULL,
  `created_at` timestamp(0) NULL DEFAULT NULL,
  `updated_at` timestamp(0) NULL DEFAULT NULL,
  PRIMARY KEY (`PK_id`) USING BTREE,
  INDEX `FK_Estudiante`(`FK_Estudiante`) USING BTREE,
  INDEX `FK_ObservacionDocente`(`FK_ObservacionDocente`) USING BTREE,
