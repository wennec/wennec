        ...
        <div class="container-fluid">
            <div class="row-shadow">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="logo-pro">
                        <a href="/inicio"><img class="main-logo" src="{{ asset('/assets/img/logo/logolarge.png') }}" alt="" /></a>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="header-top-wraper">
                                <div class="row-shadow">
                                    <div class="col-lg-1 col-md-0 col-sm-1 col-xs-12 example2">
                                        ...
                                        <a href="/inicio"><img class="main-logo img-logo" src="{{ asset('/assets/img/logo/logolarge.png') }}" alt="" /></a>
                                        </div>
                                    </div>
